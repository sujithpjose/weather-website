...
const forecast = (lat, lng, callback) => {
    ...
    request({ url, json: true }, (err, { body }) => {
        if (err) {
            ...
            const message = `Current temperature is ${body.currently.temperature} and there is ${body.currently.precipProbability} chance for rain. Summary : ${body.hourly.summary}`;
